...
export const routes = [
  ...
  { path: '/servidores', name: 'Servidores', element: Table },
  { path: '/servidores/registrar', name: 'Registro-Servidor', element: Register },
  { path: '/usuarios', name: 'Usuarios', element: Users },
  { path: '/usuarios/Roles', name: 'Roles y Permisos', element: Roles },
  { path: '/usuarios/Solicitudes-Acceso', name: 'Solicitudes De Acceso', element: AccessReq },
  { path: '/monitoreo/alertas', name: 'Alertas', element: AlertsDashboard},
  { path: '/monitoreo/estado-servicios', name: 'Estado de los servicios', element: ServiceStatus },
  { path: '/dashboard', name: 'Dashboard', element: DashboardAdmin },
  { path: '/historialCambios', name: 'HistorialCambios', element: HistorialCambios },
  { path: '/logs', name: 'logs', element: LogsViewer },
  { path: '/perfil', name: 'Perfil', element: UserProfile },
  { path: '/crear-usuario', name: 'crear_usuario', element: CreateUser },
